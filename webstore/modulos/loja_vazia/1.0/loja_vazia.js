...
function lojaVazia(){
	...
	var banner = '<li><img src="http://via.placeholder.com/1200x400" class="img-responsive"></li>';
	$('#banner-topo').html(banner).removeClass('hidden');

	var miniBanner = '<li class="col-xs-6 col-sm-3"><img src="http://via.placeholder.com/300x150" class="img-responsive"></li>';
